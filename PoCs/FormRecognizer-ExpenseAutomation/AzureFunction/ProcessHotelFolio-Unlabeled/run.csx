...
public static async Task<string> Run(EventGridEvent eventGridEvent, ILogger log)
{
    ...
    string cogSvcEndpointFormRecHotelFolioAnalyze = Environment
        .GetEnvironmentVariable("CogSvcEndpointFormRecHotelFolioAnalyze")
    ...
    log.LogInformation($"{nameof(cogSvcEndpointFormRecHotelFolioAnalyze)} = {cogSvcEndpointFormRecHotelFolioAnalyze}");
    // //////////////////////////////////////////////////
    ...
    string bodyFormRec = $"{{\"source\":\"{blobSapUrl}\"}}";

    HttpContent contentFormRec = httpUtilFormRec.GetHttpContent(bodyFormRec, contentType);

    OpResult resultFormRec = await httpUtilFormRec.PostAsync(cogSvcEndpointFormRecHotelFolioAnalyze, contentFormRec);
