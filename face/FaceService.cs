...
namespace pelazem.azure.cognitive.face
{
	public class FaceService
	{
		...
		/// <returns></returns>
		internal byte[] GetImageAsByteArray(string imageFilePath)
		{
		...
		internal ByteArrayContent GetImagePayload(byte[] image)
		{
		...
		internal HttpContent GetImageUriContent(string imageUri)
		{
		...
		internal bool ValidateFileSize(string filePath)
		{
